						...
						<div class="form-main">
							...
							<form class="form" method="post" action="ProductController" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Product name<span>*</span></label> <input name="productName"
												type="text" placeholder="Product name">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Product Price<span>*</span></label> <input name="productPrice"
									...
									<div class="col-12">
										<div class="form-group message">
											...
											<input type="file" name="productImage" placeholder="Product Image">
										</div>
									</div>
									<div class="col-12">
