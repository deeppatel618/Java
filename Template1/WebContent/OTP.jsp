				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li><a href="index.jsp">LogIN<i class="ti-arrow-right"></i></a></li>
							<li><a href="index.jsp">Forgot Password<i class="ti-arrow-right"></i></a></li>
							<li class="active"><a href="Forgot.jsp">OTP</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<input type=hidden name="redirect" value="<%=request.getAttribute("type")%>">
							<input type="hidden" name="email" value="<%=request.getAttribute("email")%>">
							<input type="hidden" name="OTP" value="<%=request.getAttribute("OTP")%>">
								<div class="row">
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>OTP<span>*</span></label> <input name="userOTP"
												type="password" placeholder="Enter OTP">
										</div>
									</div>
