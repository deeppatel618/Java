...
function searchEmail(){
	...
	var url="AJAXemail.jsp?val="+email;
	try{
		request.onreadystatechange=function()
		{
			if(request.readyState==4)
			{
				...
				document.getElementById('signupSpan').innerHTML=val;
			}	
		}
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.jsp">SignUP</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<form class="form" method="post" action="UserController" name="signupForm">
								<div class="row">
									<div class=" col-12">
									
										<tr>
											<td>Identity <span>*</span></td>
											&nbsp;&nbsp;
											<td><input type="radio" name="user" value="Customer">Customer
												&nbsp;<input type="radio" name="user" value="seller">seller</td>
										</tr><br><br>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>First Name<span>*</span></label> <input name="fname"
												type="text" placeholder="Name">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Last Name<span>*</span></label> <input name="lname"
												type="text" placeholder="Subject">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Email ID<span>*</span></label> <input name="email"
												type="email" placeholder="Email" onblur="searchEmail();">
												<span id="signupSpan"></span>
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Phone Number<span>*</span></label> <input name="phone"
												type="text" placeholder="Phone Number">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Password<span>*</span></label> <input name="password"
