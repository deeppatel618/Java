...
{
	emailid=(String)request.getAttribute("email");
}
else
{
	emailid=u.getEmail();
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.jsp">ChangePassword</a></li>
						</ul>
					</div>
				</div>
			</div>
								...
								<div class="row">
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Enter New Password<span>*</span></label> <input name="npassword"
												type="password" placeholder="New Password">
										</div>
									</div>
									<div class="col-lg-6 col-12">
										<div class="form-group">
											<label>Confirm Password<span>*</span></label> <input name="cnpassword"
