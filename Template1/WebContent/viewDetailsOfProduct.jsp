									...
									<div class="tab-single">
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<a href="editDetailsOfProduct.jsp?pid=<%=p.getPid()%>"><input type="button" name="btn" value="Edit" class="btn btn-primary">
												<a href="deleteProduct.jsp?pid=<%=p.getPid()%>"><input type="button" name="btn" value="Delete" class="btn btn-primary"></a>
											</div>
