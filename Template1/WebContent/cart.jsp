							...
							<tr>
								...
								<td class="qty" data-title="Qty"><!-- Input Order -->
									<div class="input-group">
										...
										<input type="text" name="quant[2]" class="input-number"  data-http://marketplace.eclipse.org/marketplace-client-intro?mpc_install=27025min="1" data-max="100" value="2">
										<div class="button plus">
