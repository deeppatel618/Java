					...
					<div class="col-12">
						<div class="product-info">
							<div class="nav-main">
								...
								if(category==null){%>
									<li class="nav-item"><a class="nav-link active"  href="index.jsp" role="tab">All</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=men" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=kid" role="tab">Kids</a></li>
									<%}else if(category.equalsIgnoreCase("men")){ %>
									<li class="nav-item"><a class="nav-link "  href="index.jsp" role="tab">All</a></li>
									<li class="nav-item"><a class="nav-link active"  href="index.jsp?category=men" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=kid" role="tab">Kids</a></li>
									<%}else if(category.equalsIgnoreCase("women")){ %>
									<li class="nav-item"><a class="nav-link "  href="index.jsp" role="tab">All</a></li>
									<li class="nav-item"><a class="nav-link "  href="index.jsp?category=men" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link active"  href="index.jsp?category=women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=kid" role="tab">Kids</a></li>
									<%}else if(category.equalsIgnoreCase("kid")){ %>
									<li class="nav-item"><a class="nav-link "  href="index.jsp" role="tab">All</a></li>
									<li class="nav-item"><a class="nav-link "  href="index.jsp?category=men" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link"  href="index.jsp?category=women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link active"  href="index.jsp?category=kid" role="tab">Kids</a></li>
									<%} %>
							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										...
										if(category!=null)
										{
											 list=ProductDao.getAllProduct(category);
										}
										else
										{
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.jsp"><%=p.getProductName()%></a></h3>
