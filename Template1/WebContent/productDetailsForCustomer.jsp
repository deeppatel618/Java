												...
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.jsp">
															<img class="default-img" src="images/ProductImages/<%=p.getProductImage() %>" alt="#"style="width: 200px;height: 300px;">
															<img class="hover-img" src="images/ProductImages/<%=p.getProductImage() %>" alt="#" style="width: 200px;height: 300px;">
														</a>														
													</div>													
												</div>												
											</div>							
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														...
														<h5>Category=<%=p.getProductCategory() %></h5>
														<h5>Size=<%=p.getProductSize() %></h5>
														<h5>Color=<%=p.getProductColor() %></h5>
														<h5>Description=<%=p.getProductDesc() %></h5>
														<div class="product-price">
															<span>Rs.<%=p.getproductPrice() %></span>
														</div>
													</div>
												</div>
												<%if(WishlistDao.CheckingProductInWishlist(p.getPid(), u.getId())) {%>
												<a href="AddToWishlist.jsp?pid=<%=p.getPid()%>&uid=<%=u.getId()%>&action=removefromwishlist"><input type="button" name="btn" value="Remove From wishlist" class="btn btn-primary"></a>
												<%}else { %>
												<a href="AddToWishlist.jsp?pid=<%=p.getPid()%>&uid=<%=u.getId()%>&action=addtowishlist"><input type="button" name="btn" value="Add to wishlist" class="btn btn-primary"></a>
												<%} %>
												<%if(CartDao.CheckingProductInCart(p.getPid(), u.getId())) {%>
												<a href="AddToCart.jsp?pid=<%=p.getPid()%>&uid=<%=u.getId()%>&action=removefromcart"><input type="button" name="btn" value="Remove From cart" class="btn btn-primary"></a>
												<%}else{ %>
												<a href="AddToCart.jsp?pid=<%=p.getPid()%>&uid=<%=u.getId()%>&action=addtocart"><input type="button" name="btn" value="Add to cart" class="btn btn-primary"></a>
												<%} %>
											</div>
