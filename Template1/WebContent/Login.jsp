	...
	try{
		request.onreadystatechange=function()
		{
			if(request.readyState==4)
			{
				...
				document.getElementById('signupSpan').innerHTML="Email id not registered";
			}	
		}
				...
				<div class="row">
					<div class="col-lg-8 col-12">
						<div class="form-main">
							...
							<form  name ="loginForm" class="form" method="post" action="UserController">
								<div class="row">
									...
									<div class="col-8">
										<div class="form-group button">
											<a href="Signup.jsp"><button type="button" class="btn " name="action"
												value="Insert">SIGN UP</button></a><span style="font-size: 20px">New User?</span>
										</div>
									</div>
									
									<div class="col-4" >
										<div class="form-group button" >
											<a href="Forgot.jsp"><button type="button" class="btn" name="action"
												value="forgot">Forgot Password?</button></a>
										</div>
									</div>
								</div>
							</form>
