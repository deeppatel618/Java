...
<body class="js">	
<% ArrayList<ProductData> list =ProductDao.getAllProductBySeller(u.getId());
									...
									<div class="tab-single">
										...
										<%for(ProductData p:list)
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<a href="viewDetailsOfProduct.jsp?pid=<%=p.getPid()%>"><input type="button" name="btn" value="view details" class="btn btn-primary"></a>
											</div>
											<%} %>
